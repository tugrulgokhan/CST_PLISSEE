            ...
            <div class="kalka">
                ...
                <div class="form">
                    ...
                    <div class="form-field">
                        ...
                        <select id="mMaterial">
                            <optgroup  label="PERL - PREISGRUPPE 0">
                                <option value="1" >PERL 101</option>
                                <option value="2">PERL 102</option>
                                <option value="3">PERL 103</option>
                                <option value="4">PERL 104</option>
                                <option value="5">PERL 105</option>
                                <option value="6">PERL 106</option>
                                <option value="7">PERL 107</option>
                                <option value="8">PERL 108</option>
                                <option value="9">PERL 109</option>
                                <option value="10">PERL 110</option>
                                <option value="11">PERL 111</option>
                            </optgroup>
                            <optgroup label="PERL VISTA - PREISGRUPPE 1">
                                <option value="12">PERL VISTA 201</option>
                                <option value="13">PERL VISTA 202</option>
                                <option value="14">PERL VISTA 203</option>
                                <option value="15">PERL VISTA 204</option>
                                <option value="16">PERL VISTA 205</option>
                                <option value="17">PERL VISTA 206</option>
                                <option value="18">PERL VISTA 207</option>
                                <option value="19">PERL VISTA 208</option>
                                <option value="20">PERL VISTA 209</option>
                                <option value="21">PERL VISTA 220</option>
                                <option value="22">PERL VISTA 221</option>
                            </optgroup>
                        </select>
                        <div class="clearfix"></div>
                    </div>
