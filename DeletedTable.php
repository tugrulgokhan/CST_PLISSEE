...
<html>
  ...
  <div>
      <button style="width: 50%; height: 10%; background-color: #7d0000; color: white; font-size: xx-large; border-radius: 40px/40px; " type="button" onclick="location.href='willtable.php';"><b>WILL</b></button><button style="width: 50%; height: 10%; background-color: darkgreen; color: white; font-size: xx-large; border-radius: 40px/40px; " type="button" onclick="location.href='donetable.php';"><b>DONE</b></button>
  </div>
  </body>
</html>
