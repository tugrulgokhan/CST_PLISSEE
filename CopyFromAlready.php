...
<script type="text/javascript">
    ...
    var calculatePrice = function(e) {
        try {
            ...
            var price = parseFloat(priceWidhtHeight[priceGroup][ww][hh]);
    ...
    var addPrice = function() {
        ...
        td.innerHTML = 'B ' + mWidth.value + ' x H ' + mHeight.value + ' mm, ' + mColor.value + ', '+ material+', Montage ' + mMontage.value + ', ' + price +' &#8364;';
        tr.appendChild(td);
        var td = document.createElement('td');
